...
public class ProfileController {
	...
	ResponseEntity<SingleResponse<Void>> userProfileAdd(
	...
	ResponseEntity<SingleResponse<Object>> userProfileModify(@RequestPart(required = false) MultipartFile profileImage,
