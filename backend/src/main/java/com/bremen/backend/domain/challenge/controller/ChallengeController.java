...
public class ChallengeController {
	...
	@PostMapping
	@Operation(summary = "챌린지를 등록합니다.", description = "챌린지 곡과 일정, 챌린지 내용을 입력받아 챌린지를 등록합니다.")
	ResponseEntity<CustomResponse<ChallengeResponse>> challengeAdd(
		...
		@RequestPart(value = "content") MultipartFile content) throws IOException {
		ChallengeResponse challengeResponse = challengeService.addChallenge(challengeRequest, content);
